...
export default function AuthButtons({ next = "/app", label = "Registrar" }: { next?: string; label?: string }) {
  ...
  return (
    <div className="auth-buttons">
      <button className="oauth google" type="button" disabled={busy !== null} onClick={() => signIn("google")}>
      ...
      <button className="oauth apple" type="button" disabled={busy !== null} onClick={() => signIn("apple")}>
